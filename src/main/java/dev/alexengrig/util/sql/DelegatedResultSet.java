...
public class DelegatedResultSet implements ResultSet {
    ...
    protected DelegatedResultSet(ResultSet rs) {
        this.rs = Objects.requireNonNull(rs, "rs must not be null");
    }
    ...
    public static ResultSet wrap(ResultSet resultSet) throws SQLException {
        ...
        return new DelegatedResultSet(unwrappedRs);
    }

    public static ResultSet unwrap(ResultSet resultSet) throws SQLException {
        if (resultSet.isWrapperFor(DelegatedResultSet.class)) {
            final DelegatedResultSet wrapper = resultSet.unwrap(DelegatedResultSet.class);
    ...
    public boolean isWrapperFor(Class<?> iface) {
        return Objects.requireNonNull(iface, "iface must not be null").isAssignableFrom(getClass());
    }

    @Override
    public <T> T unwrap(Class<T> iface) {
        if (Objects.requireNonNull(iface, "iface must not be null").isAssignableFrom(getClass())) {
            return iface.cast(this);
        }
        throw new IllegalArgumentException("Cannot unwrap to " + iface.getName());
    }
    ...
    public boolean equals(Object o) {
        ...
        DelegatedResultSet that = (DelegatedResultSet) o;
